...
import com.boot.board_250618.dao.UserDAO;
...
//        알아서 오토인크리먼트 됨 1L 넣으면
    ...
    //조회
//    public Optional<User> findByUsingMapper(Long id){
//    public ArrayList<User> findByUsingMapper(Long id){
    public ArrayList<UserRole> findByUsingMapper(Long id){
